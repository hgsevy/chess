...
public class ChessPiece {
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        switch (type){
            case KING:
                return checkKingMoves(board, myPosition);
            case QUEEN:
                // check row left
            ...
            case BISHOP:
                ...
                break;
            case KNIGHT:
                return checkKnightMoves(board, myPosition);
            case ROOK:
                return checkSquareMoves(board, myPosition);
            case PAWN:
                return checkPawnMoves(board, myPosition);
        }
        return answer;

    }

    private Collection<ChessMove> checkKingMoves(ChessBoard board, ChessPosition myPosition){
    ...
    private Collection<ChessMove> checkKnightMoves(ChessBoard board, ChessPosition myPosition){
        int row = myPosition.row();
        int col = myPosition.col();
